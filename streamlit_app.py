...
def calculate_pfss_solution_ray(gong_map, rss, coord_sys):
    return calculate_pfss_solution(gong_map=gong_map, rss=rss, coord_sys=coord_sys)
        ...
        if run_pfss:
            with st.spinner('Running PFSS analysis, please wait...'):
                ...
                try:
                    ...
                    future = calculate_pfss_solution_ray.remote(gong_map=gong_map, rss=rss, coord_sys=coord_sys)
